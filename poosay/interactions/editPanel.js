...
async function handleSlashEdit(interaction) {
  ...
  if (templateIds.length === 0) {
    return interaction.reply({ content: t(lang, 'edit.noTemplates'), ephemeral: true });
  }
...
async function handleEditButton(interaction) {
  ...
  if (!template) {
    return interaction.reply({ content: t(lang, 'edit.notFound'), ephemeral: true });
  }
...
async function handleModalSubmit(interaction) {
  ...
  await interaction.reply({ content: t(lang, 'edit.saved', { id: templateId }), ephemeral: true });
}
